...
public class ApiClient {
    ...
    public static String getNewsListUrl(final int catalog, final int pageIndex, final int pageSize) {
        String newUrl = _MakeURL(URLs.NEWS_LIST, new HashMap<String, Object>() {{
            put("catalog", catalog);
            put("pageIndex", pageIndex);
            put("pageSize", pageSize);
    ...
    public static String getPostListUrl(final int catalog, final int pageIndex, final int pageSize) {
        String newUrl = _MakeURL(URLs.POST_LIST, new HashMap<String, Object>() {{
            put("catalog", catalog);
            put("pageIndex", pageIndex);
            put("pageSize", pageSize);
    ...
    public static String getTweetListUrl(final int uid, final int pageIndex, final int pageSize) {
        String newUrl = _MakeURL(URLs.TWEET_LIST, new HashMap<String, Object>() {{
            put("uid", uid);
            put("pageIndex", pageIndex);
            put("pageSize", pageSize);
    ...
    public static String getActiveListUrl(final int uid, final int catalog, final int pageIndex, final int pageSize) {
        String newUrl = _MakeURL(URLs.ACTIVE_LIST, new HashMap<String, Object>() {{
            put("uid", uid);
            put("catalog", catalog);
            put("pageIndex", pageIndex);
